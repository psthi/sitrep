...
const RSS_FEEDS = [
  ...
  { url: "https://www.al-monitor.com/rss", source: "Al-Monitor", priority: "high" },
  { url: "https://www.middleeastmonitor.com/feed/", source: "Middle East Monitor", priority: "high" },
  { url: "https://news.google.com/rss/search?q=Middle+East&hl=en-US&gl=US&ceid=US:en", source: "Google News: Middle East", priority: "medium" },
  { url: "https://news.google.com/rss/search?q=global+deficit&hl=en-US&gl=US&ceid=US:en", source: "Google News: Global Deficit", priority: "medium" },
  { url: "https://news.google.com/rss/search?q=economic+crisis&hl=en-US&gl=US&ceid=US:en", source: "Google News: Economic Crisis", priority: "medium" },
  { url: "https://news.google.com/rss/search?q=terrorist+plot&hl=en-US&gl=US&ceid=US:en", source: "Google News: Terrorist Plot", priority: "high" },
  { url: "https://news.google.com/rss/search?q=power+outage&hl=en-US&gl=US&ceid=US:en", source: "Google News: Power Outage", priority: "medium" },
  { url: "https://news.google.com/rss/search?q=infrastructure+attack&hl=en-US&gl=US&ceid=US:en", source: "Google News: Infrastructure Attack", priority: "high" },
  { url: "https://news.google.com/rss/search?q=military+deployment&hl=en-US&gl=US&ceid=US:en", source: "Google News: Military Deployment", priority: "high" },
