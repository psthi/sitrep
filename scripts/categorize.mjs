...
export const SOURCE_TYPES = {
  ...
  "Al-Monitor": "REGIONAL WIRE",
  "Middle East Monitor": "REGIONAL WIRE",
  "Google News: Middle East": "REGIONAL WIRE",
  "Google News: Global Deficit": "MACROECONOMICS",
  "Google News: Economic Crisis": "MACROECONOMICS",
  "Google News: Terrorist Plot": "GLOBAL SECURITY",
  "Google News: Power Outage": "INFRASTRUCTURE",
  "Google News: Infrastructure Attack": "INFRASTRUCTURE",
  "Google News: Military Deployment": "DEFENSE / TECH",
  "BBC": "GLOBAL WIRE",
